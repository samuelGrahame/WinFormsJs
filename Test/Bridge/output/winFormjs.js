Bridge.assembly("WinFormjs", function ($asm, globals) {
    ...
    Bridge.define("WinFormjs.Form", {
        statics: {
            ...
            createStartButton: function () {
                ...
                butt.style.background = WinFormjs.IconRepository.wrapBase64(WinFormjs.IconRepository.IMAGE_WinIcon);
                ...
                butt.onmousedown = function (ev) {
                    ...
                    butt.style.background = WinFormjs.IconRepository.wrapBase64(WinFormjs.IconRepository.IMAGE_WinIconDown);
                ...
                butt.onmouseenter = function (ev) {
                    ...
                    if (WinFormjs.Form.getMouse_Down()) {
                        ...
                        butt.style.background = WinFormjs.IconRepository.wrapBase64(WinFormjs.IconRepository.IMAGE_WinIconHover);
                    }
                };
            ...
            if (WinFormjs.Form.movingForm != null) {
                ...
                switch (WinFormjs.Form.moveAction) {
                    ...
                    case WinFormjs.Form.MouseMoveAction.TopLeftResize: 
                        WinFormjs.Rectange.setBounds(X1, Y1, W, H, obj);
                        W.v = (W.v - (((X - X1.v) | 0))) | 0;
                        H.v = (H.v - (((Y - Y1.v) | 0))) | 0;
    ...
    Bridge.define("WinFormjs.IconRepository", {
        statics: {
            ...
            IMAGE_WinIcon: "data:image/png;base64,",
            IMAGE_WinIconHover: "data:image/png;base64,",
            IMAGE_WinIconDown: "data:image/png;base64,",
            wrapBase64: function (source) {
                return System.String.format("url('{0}')", source);
            },
            /**
    ...
    Bridge.define("WinFormjs.MenuItem", {
        config: {
            properties: {
                Image: null,
                Caption: null,
    ...
    Bridge.define("WinFormjs.Point", {
        $kind: "struct",
        statics: {
            getDefaultValue: function () { return new WinFormjs.Point(); }
        },
        x: 0,
        y: 0,
        $ctor1: function (x, y) {
        ...
        equals: function (o) {
            if (!Bridge.is(o, WinFormjs.Point)) {
                return false;
            }
            return Bridge.equals(this.x, o.x) && Bridge.equals(this.y, o.y);
        },
        $clone: function (to) {
            var s = to || new WinFormjs.Point();
            s.x = this.x;
            s.y = this.y;
            return s;
        }
    ...
    Bridge.define("WinFormjs.PopupMenu", {
        statics: {
            BeginGroupColor: "#919191",
            BorderColor: "#A0A0A0",
        ...
        config: {
            ...
            init: function () {
                this.items = new (System.Collections.Generic.List$1(WinFormjs.MenuItem))();
            }
        },
        show: function (location) {
            ...
            this.getBase().style.borderColor = WinFormjs.PopupMenu.BorderColor;
            this.getBase().style.borderStyle = "solid";
            this.getBase().style.borderWidth = "thin";
    ...
    Bridge.define("WinFormjs.Size", {
        $kind: "struct",
        statics: {
            getDefaultValue: function () { return new WinFormjs.Size(); }
        },
        width: 0,
        height: 0,
        ...
        getHashCode: function () {
            var hash = 17;
            hash = hash * 23 + 1702521171;
            hash = hash * 23 + (this.width == null ? 0 : Bridge.getHashCode(this.width));
            hash = hash * 23 + (this.height == null ? 0 : Bridge.getHashCode(this.height));
            return hash;
        },
        equals: function (o) {
            if (!Bridge.is(o, WinFormjs.Size)) {
                return false;
            }
            return Bridge.equals(this.width, o.width) && Bridge.equals(this.height, o.height);
        },
        $clone: function (to) {
            var s = to || new WinFormjs.Size();
            s.width = this.width;
            s.height = this.height;
            return s;
        }
    ...
    Bridge.define("WinFormjs.SubMenuItem", {
        inherits: [WinFormjs.MenuItem],
        config: {
            properties: {
                Menu: null
            }
