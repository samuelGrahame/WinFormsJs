Bridge.assembly("Test", function ($asm, globals) {
    ...
    Bridge.define("Test.FileExplorerNode", {
        statics: {
            createNode: function (path, nvt, parent, IsFile) {
                ...
                fen.setIcon(Test.IconRepository.getIconByFileName(fen.getName()));
        ...
        createHtmlNode: function () {
                ...
                if (this.getnodeViewType() === Test.NodeViewType.Medium_Icons) {
                    ...
                    if (this.getIsFile()) {
                        if (Bridge.referenceEquals(this.getIcon(), "")) {
                            img.setAttribute("src", Test.IconRepository.IMAGE_File); // NodeImage.Style.Background = FileExplorer.IMAGE_File;
                        } else {
                            img.setAttribute("src", this.getIcon()); // NodeImage.Style.Background = FileExplorer.IMAGE_File;
                        }
                    } else {
                        img.setAttribute("src", Test.IconRepository.IMAGE_Folder);
            ...
            if (this.getnodeViewType() === Test.NodeViewType.Medium_Icons) {
                if (this.nodeState === Test.FileExplorerNode.FileExplorerState.Focused || this.nodeState === Test.FileExplorerNode.FileExplorerState.HoverFocused) {
    ...
    Bridge.define("Test.IconRepository", {
        statics: {
            ...
            getIconByFileName: function (Name) {
                if (Bridge.referenceEquals(Name, "cmd.exe")) {
                    return Test.IconRepository.IMAGE_CMD;
                } else if (Bridge.referenceEquals(Name, "Notepad.exe")) {
                    return Test.IconRepository.IMAGE_Notepad;
                }
                return "";
            }
        }
